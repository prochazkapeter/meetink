...
#define GDEW075Z08_WIDTH 800
#define GDEW075Z08_HEIGHT 480
...
#define GDEW075Z08_BUFFER_SIZE (uint32_t(GDEW075Z08_WIDTH) * uint32_t(GDEW075Z08_HEIGHT) / 8)
// 8 pix of this color in a buffer byte:
#define GDEW075Z08_8PIX_BLACK 0x00
#define GDEW075Z08_8PIX_WHITE 0xFF
...
class Gdew075Z08 : public Epd
{
public:
  Gdew075Z08(EpdSpi &IO);
...
private:
  ...
  uint8_t _buffer[GDEW075Z08_BUFFER_SIZE];
  // Place _buffer in external RAM
  // uint8_t* _buffer = (uint8_t*)heap_caps_malloc(GDEW075Z08_BUFFER_SIZE, MALLOC_CAP_SPIRAM);
